                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <Link
                              href={`/staffly/staff/${n.staffId}/certifications`}
                ...
                {d.absentToday.length === 0 ? (
                  ...
                  <ul className="divide-y divide-line">
                    {d.absentToday.map((a) => (
                      ...
                      >
                        <Link
                          href={`/staffly/staff/${a.staffId}/absence`}
